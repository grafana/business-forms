 ...
 * Props
 */
type Props = React.ComponentProps<typeof DatasourceQueryEditor>;
...
describe('DatasourceQueryEditor', () => {
  ...
  const getComponent = (props: Partial<Props>) => {
    return <DatasourceQueryEditor {...(props as any)} />;
  };
  ...
  it('Should clear query if different data source type', async () => {
    ...
    /**
     * Data Source Mock — different type
     */
  ...
  it('Should keep query if same data source type', async () => {
    ...
    /**
     * Data Source Mock — same type, different uid
     */
    jest.mocked(getDataSourceSrv).mockReturnValue({
      get: jest.fn(() => ({
        type: 'grafana-postgres',
    ...
    /**
     * Check that onChange was NOT called (no change triggered)
     */
